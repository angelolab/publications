...
df_X_matrix = read.csv('data/genomics/rna_df_matrix_baseline_signature.csv', header=TRUE)
...
write.csv(combined_results, file = "./results/genomics/top_features_results_baseline_RNA_signature.csv", row.names = FALSE)
...
df_X_matrix = read.csv('data/genomics/rna_df_matrix_post_induction_signature.csv', header=TRUE)
colnames(df_X_matrix)[1] = "Patient_ID"
...
write.csv(combined_results, file = "./results/genomics/top_features_results_inducion_RNA_signature.csv", row.names = FALSE)
...
df_X_matrix = read.csv('data/genomics/rna_df_matrix_on_nivo_signature.csv', header=TRUE)
colnames(df_X_matrix)[1] = "Patient_ID"
...
write.csv(combined_results, file = "./results/genomics//top_features_results_nivo_RNA_signature.csv", row.names = FALSE)
...
write.csv(all_results, file = "./results/genomics/all_timepoints_results_genomics.csv", row.names = FALSE)
