...
max_feats = 20
max_feats = max_feats - 1

######################### ######################### ######################### 
######################### On Nivo #########################
######################### ######################### #########################

df_dir = paste('/Volumes/Shared/Noah Greenwald/TONIC_Cohort/prediction_model', sep = '')
out_dir = paste('/Volumes/Shared/Noah Greenwald/TONIC_Cohort/supplementary_figs/review_figures/limit_model_features/prediction_model_', max_feats+1, '/patient_outcomes', sep = '')


df_X_matrix = read.csv(paste(df_dir, '/df_matrix_on_nivo.csv', sep = ''), header=TRUE)
colnames(df_X_matrix)[1] = "Patient_ID"

df = read.csv(paste(df_dir, '/timepoint_combined_features.csv', sep = ''), header=TRUE)
...
write.csv(combined_results, file = paste(out_dir, "/top_features_results_on_nivo_MIBI.csv", sep = ''), row.names = FALSE)
...
df_X_matrix = read.csv(paste(df_dir, '/df_matrix_baseline.csv', sep = ''), header=TRUE)
colnames(df_X_matrix)[1] = "Patient_ID"
...
write.csv(combined_results, file = paste(out_dir, "/top_features_results_baseline_MIBI.csv", sep=''), row.names = FALSE)
...
df_X_matrix = read.csv(paste(df_dir, '/df_matrix_pre_nivo.csv', sep=''), header=TRUE)
colnames(df_X_matrix)[1] = "Patient_ID"
...
write.csv(combined_results, file = paste(out_dir, "/top_features_results_pre_nivo_MIBI.csv", sep=''), row.names = FALSE)

######################### ######################### ######################### 
######################### Primary #########################
######################### ######################### ######################### 

df_X_matrix = read.csv(paste(df_dir, '/df_matrix_primary.csv', sep=''), header=TRUE)
colnames(df_X_matrix)[1] = "Patient_ID"
...
write.csv(combined_results, file = paste(out_dir, "/top_features_results_primary_MIBI.csv", sep=''), row.names = FALSE)
...
write.csv(all_results, file = paste(out_dir, "/all_timepoints_results_MIBI.csv", sep=''), row.names = FALSE)