...
# Date created: 231204
#
# Overview: This script generates a heatmap of marker expression in all the cell
# clusters present in the data. The heatmap represents the mean expression of
# each marker.
...
##..Step 2: Make heatmap based on marker expression to validate..##
