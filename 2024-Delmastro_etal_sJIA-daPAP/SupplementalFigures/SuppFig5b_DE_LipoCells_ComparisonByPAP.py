...
def main():
    ...
    all_cells = ["Endothelial", "CD11c+_mDC", "CD57+_ImmuneOther", "iNOS+_Mac", "iNOS+_Pneumocyte", "Fibroblast", "CD209+_Mac", "CD8+_Tcell", "Neutrophil", "CD14+_Mono", "Bcell", "CD4+_Tcell", "M2_Mac", "Treg", "Mesenchymal", "Lung_Epithelium", "Mast_cell", "CD57+_CD8+_Tcell", "Eosinophil", "CD16+_ImmuneOther"]
    ...
    plt.savefig(path + '/Sub-panels/SupplementalFigures/SuppFig5b_DE_LipoCells_'+ cat +'_only.png', dpi = 1000, transparent = True)
