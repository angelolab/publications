...
highlight <- tribble(
  ...
  "FNIII 5", 985,     1075,   0, #adjust for vis from 999,1088 for 
  "EDB",     1271,    1359,   0
)

# --- Plot ---
pdf("R_plots/glycoproteomics/FN1_sequence_alldomains.pdf", , width = 6, height = 3)
ggplot() +
  # Protein backbone
  ...
  geom_rect(
    data = highlight,
    aes(xmin = start, xmax = end, ymin = -0.07, ymax = 0.07),
    fill = "grey40", color = NA, alpha = 0.4
  )+
...
pdf("R_plots/glycoproteomics/FN1_glycantypes.pdf", , width = 4, height = 3)
